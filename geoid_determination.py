...
valid = []
# Reading File
cp = pd.read_csv('10160617_controlpoints.txt', sep='\s+', names=["ID", "latitude", "longitude", "H", "h"])
tp = pd.read_csv('10160617_testpoints.txt', sep='\s+', names=["ID", "latitude", "longitude", "H", "h"])
